...
<div class="container" >
  <div class="form-container">
    ...
    <form method="post" action="con_edit.php" enctype="multipart/form-data" >
      <div class="form-row">
        <div>
          <img src="images/<?php echo $photo ?>" alt="" width="100" height="100">
        </div>
      </div>
      <div class="form-row">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-4">
          ...
          <select class="form-select form-control" name= "course" aria-label="Default select example" disabled>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="tel" class="form-control" name="phone" placeholder="Contact Number" value="<?php echo $phone ?>" readonly>
        </div>
        <div class="form-group col-md-6">
          <label for="totalfees">Total Fees</label>
          <input type="text" class="form-control" name="totalfees" placeholder="Total Fees" value="<?php echo $totalfees ?>" readonly>
        </div>
      </div>
  ...
  <table class="table mt-4">
            ...
            <?php   
              $sql = "select * from fees1 where c_id=$id";
              $result = mysqli_query($conn,$sql);
                 while($row = mysqli_fetch_array($result))
                 {
            ?>
